    ...
    <div className="max-w-4xl mx-auto h-[400px] mt-10 p-8 bg-white rounded-lg shadow-md">
      ...
      <div className="flex flex-row items-center">
        ...
        <div className="w-full">
          ...
          <div className="flex py-2">
            <div className="w-1/2 font-medium text-right pr-6">Employee ID:</div>
            <div className="w-1/2">{employee.employeeId}</div>
          </div>
          
          <div className="flex py-2">
            <div className="w-1/2 font-medium text-right pr-6">Date of Birth:</div>
            <div className="w-1/2">{new Date(employee.dob).toLocaleDateString("en-GB")}</div>
          </div>
          ...
          <div className="flex py-2">
            <div className="w-1/2 font-medium text-right pr-6">Marital Status:</div>
