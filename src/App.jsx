    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path='/admin-dashboard' element={
          ...
          <Route path='/admin-dashboard/employee' element={<ListEmployee />}></Route>
        ...
        <Route path='/employee-dashboard' element={
          ...
          <Route path='/employee-dashboard/employee/:id' element={<EmployeeProfile />}></Route>
          <Route path='/employee-dashboard/leave' element={<LeaveList />}></Route>
          <Route path='/employee-dashboard/addleave' element={<AddLeave />}></Route>
          <Route path='/employee-dashboard/salary' element={<SalaryHistory />}></Route>
